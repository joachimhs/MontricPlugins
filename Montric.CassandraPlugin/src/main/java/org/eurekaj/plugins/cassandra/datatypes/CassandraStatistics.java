 ...
 */
public class CassandraStatistics implements Comparable<Statistics>, Statistics {
    ...
    public CassandraStatistics(String guiPath, String nodeLive) {
        this();
